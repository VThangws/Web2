...
<body>
    ...
    require_once __DIR__ . '/../../../../DAO/Sach/DauSachDAO.php';
    ...
    <div class="KhungDanhSach">
        <table>
            ...
            foreach ($danhsach as $item) {
                ...
                echo "<td><a href='Sua_DauSach.php?madausach=" . $item->getMadausach() . "'>Sửa</a> | <a href='QL_DauSach.php?luachon=Xoa&madausach=" . $item->getMadausach() . "'>Xóa</a></td>";
                echo '</tr>';
            }
            ?>
        </table>
