<?php
// Footer cho website thư viện
?>
<footer class="az-footer section-p1">
    <div class="az-footer-inner">
        ...
        <!-- Cột 4: Chính sách -->
        <div class="col az-footer-col">
            <h4>Quy định thư viện</h4>
            <ul>
                <li><a href="#">Quy định mượn sách</a></li>
                <li><a href="#">Quy định trả sách</a></li>
                <li><a href="#">Quy định sử dụng thư viện</a></li>
                <li><a href="#">Chính sách bảo mật</a></li>
                <li><a href="#">Hỗ trợ bạn đọc</a></li>
            </ul>
        </div>
        ...
        <div class="col az-footer-col">
            <h4>Hướng dẫn</h4>
            <ul>
                <li><a href="#">Hướng dẫn đăng ký thẻ thư viện</a></li>
                <li><a href="#">Hướng dẫn mượn sách</a></li>
                <li><a href="#">Hướng dẫn tra cứu tài liệu</a></li>
